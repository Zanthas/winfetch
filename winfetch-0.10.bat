...
colous Writesec "[12]        Et:::ztt33EEE  [26]@Ee.,      .., [7]Kernel version:[15] %osvers:~0,8%"
...
colous Writesec "[9]    ;::::::::zt33)   [26]'4EEEtttji3P*    [7]BIOS: [15] %bios:~0,34%"
...
nircmd.exe beep 500 200
Set /P var=1... <NUL
nircmd.exe savescreenshotfull "Screenshot-CMDfetch-~$currdate.MM-dd-yy$-~$currtime.HHmm$.png"
nircmd.exe beep 700 600
nircmd.exe trayballoon "CMDFetch" "Screenshot Taken!" "shell32.dll,-1001" 15000 
set var=
set vr=
set b=
set c1u=
