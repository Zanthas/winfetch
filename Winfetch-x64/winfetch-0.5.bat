...
colous Writesec "[9]  ;:::::::::t33V [14];EEEttttt::::t3      [7]CPU: [15]%cpu:~-23,35%"
...
timeout /t 1 /nobreak > NUL
Set /P var=1... <NUL
nircmd.exe savescreenshotfull "C:\Users\NAME\Screenshot-Winfetch-~$currdate.MM-dd-yy$-~$currtime.HHmm$.png"
set var=
set vr=
set b=
goto :EOF
